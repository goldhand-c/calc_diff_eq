...
\begin{question}
    ...
    \begin{align*}
        P_4(x) & = \frac{1}{2^n n!} \dv[n]{x} (x^2 - 1)^n \bigg|_n=4                                     \\
...
\begin{question}[resume]
    ...
    \begin{align*}
        s Y(s) - y(0) + 2 Y(s) + \frac2s \mathcal{L}\left\{y(t-x)\right\} & = \frac2{s^2}
    \end{align*}
    % ----------------------------------------
\end{question}
...
\begin{question}[resume]
    ...
    \begin{question}
        ...
        \vspace*{-3.67em}
        \begin{flalign*}
            \phantom{\mathcal{L}^{-1}\left\{\frac{s}{s^2+2s+10}\right\}} & = \mathcal{L}^{-1}\left\{\frac{s}{(s+1)^2+6}\right\}                         & \\
                                                                         & = \mathcal{L}^{-1}\left\{\frac{s+1}{(s+1)^2+6} - \frac{1}{(s+1)^2+6}\right\}   \\
                                                                         & = \boxed{e^{-t}(\sin t - \cos t)}
        \end{flalign*}
    \end{question}
