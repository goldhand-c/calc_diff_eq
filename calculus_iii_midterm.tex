...
\begin{question}
    ...
    \begin{question}
        ...
        \begin{enumerate}[label=(\alph*),topsep=1.5em,itemsep=3em]
            ...
            \item $\displaystyle \int_0^{\pi/6} \sin^2 \theta \, d \theta = \ansbox$ \\[1em]
                  $\displaystyle \int_{\pi/6}^{\pi/2} (1 - \sin \theta)^2 \, d \theta = \ansbox$
    ...
    \begin{question}
        ...
        \item เมื่อจัดรูปสมการ $4x^2 - y^2 + 3z^2 + 8x - 6z = 0$ ของผิวควอดริก โดยใช้วิธีกำลังสองสมบูรณ์ \\[.5em]
