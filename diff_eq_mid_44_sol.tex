...
\begin{question}
    ...
    \medskip
    Since we have 2 linearly independent solutions, we can conclude that the solution to this relative homogenous equation is
    $$
        y = c_1 e^x + c_2 x
    $$
    ...
    \begin{align*}
        ...
        \phi_0            & = \frac{3\pi}{4}
    \end{align*}
    The amplitude is $\boxed{\frac{\sqrt2}3\,\si{ft}}$ and the angle of departure is $\boxed{\frac{3\pi}{4}\,\si{rad}}$.
    % ----------------------------------------
